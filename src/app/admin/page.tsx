...
async function DashboardStats() {
  try {
    ...
    return (
      <div className="p-6 rounded-xl border border-destructive/20 bg-destructive/10">
        <p className="text-sm text-destructive font-medium">Database Error</p>
        <p className="text-xs text-muted-foreground mt-1">
          Could not load dashboard data. Please ensure Turso environment variables are configured and database tables exist.
        </p>
      </div>
    );
  }

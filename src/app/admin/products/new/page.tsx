...
import { createProduct, getCategories, getBrands } from "@/actions/admin/products";
            ...
            <CardContent className="grid gap-4">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="discountPercent" name="discountPercent" type="number" min="0" max="100" defaultValue="0" />
                </div>
              </div>
              <div className="space-y-2">
            ...
            <CardContent className="grid gap-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="cosmeticCondition" name="cosmeticCondition" />
                </div>
              </div>
              <div className="space-y-2">
                <Label htmlFor="testingStatus">Testing Status</Label>
                <Input id="testingStatus" name="testingStatus" />
              </div>
              <div className="space-y-2">
          ...
          <Card>
            ...
            <CardContent className="grid gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input id="model3DUrl" name="model3DUrl" placeholder="https://..." />
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="grid gap-4">
              ...
              <div className="flex flex-wrap gap-6">
                <div className="flex items-center gap-2">
                  <input type="checkbox" id="isFeatured" name="isFeatured" className="h-4 w-4 rounded border-border" />
                  <Label htmlFor="isFeatured">Featured</Label>
                </div>
                <div className="flex items-center gap-2">
                  <input type="checkbox" id="isTrending" name="isTrending" className="h-4 w-4 rounded border-border" />
                  <Label htmlFor="isTrending">Trending</Label>
                </div>
                <div className="flex items-center gap-2">
                  <input type="checkbox" id="isActive" name="isActive" defaultChecked className="h-4 w-4 rounded border-border" />
